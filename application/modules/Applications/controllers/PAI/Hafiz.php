...
class Hafiz extends CI_Controller {
    ...
    public function index() {
        $data = [
            'data' => $this->bodo->Curel('simpenaiss/hafiz?KEY=BOBA'),
    ...
    public function Provinsi() {
        ...
        $data = [
            'data' => $this->bodo->Curel('simpenaiss/hafiz?KEY=BOBA&province_id=' . $param[0]),
            'param' => $param,
            'item_active' => 'Applications/PAI/Hafiz/index/',
            'privilege' => $this->bodo->Check_previlege('Applications/PAI/Hafiz/index/'),
            'siteTitle' => 'Hafidz & Hafidzah | ' . $this->bodo->Sys('app_name'),
    ...
    public function Kabupaten() {
        ...
        $data = [
            'data' => $this->bodo->Curel('simpenaiss/hafiz?KEY=BOBA&city_id=' . $param[2]),
            'param' => $param,
            'item_active' => 'Applications/PAI/Hafiz/index/',
            'privilege' => $this->bodo->Check_previlege('Applications/PAI/Hafiz/index/'),
            'siteTitle' => 'Hafidz & Hafidzah | ' . $this->bodo->Sys('app_name'),
