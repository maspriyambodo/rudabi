...
class Kaligrafer extends CI_Controller {
    ...
    public function index() {
        $data = [
            'data' => $this->bodo->Curel('simpenaiss/kaligrafer?KEY=BOBA'),
    ...
    public function Provinsi() {
        ...
        $data = [
            'data' => $this->bodo->Curel('simpenaiss/kaligrafer?KEY=BOBA&province_id=' . $param[0]),
            'param' => $param,
            'item_active' => 'Applications/PAI/Kaligrafer/index/',
            'privilege' => $this->bodo->Check_previlege('Applications/PAI/Kaligrafer/index/'),
            'siteTitle' => 'Data Kaligrafer | ' . $this->bodo->Sys('app_name'),
    ...
    public function Kabupaten() {
        ...
        $data = [
            'data' => $this->bodo->Curel('simpenaiss/kaligrafer?KEY=BOBA&city_id=' . $param[2]),
            'param' => $param,
            'item_active' => 'Applications/PAI/Kaligrafer/index/',
            'privilege' => $this->bodo->Check_previlege('Applications/PAI/Kaligrafer/index/'),
            'siteTitle' => 'Data Kaligrafer | ' . $this->bodo->Sys('app_name'),
