                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (!isset($b->province_title)) {
                                    ...
                                    echo '<a href="' . base_url('Applications/Binsyar/Lokasi/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->lokasi_provinsi . '&b=' . $b->province_title))) . '" title="" class="btn btn-icon btn-default btn-xs"><i class="fas fa-eye"></i></a>';
                                }
                                ?>
                            </td>
                        </tr>
