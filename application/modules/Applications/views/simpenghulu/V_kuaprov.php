...
<div class="card card-custom" data-card="true" id="kt_card_1">
    <div class="card-header">
        <div class="card-title">
            <a href="<?php echo base_url('Applications/Simpenghulu/KUA/index'); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
                ...
                <tbody>
                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('Applications/Simpenghulu/KUA/Detail?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->kua_city_id . '&b=' . $b->city_title . '&c=' . $param[0] . '&d=' . $param[1]))); ?>" class="btn btn-icon btn-default btn-xs" title="Detail <?php echo $b->city_title; ?>"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
