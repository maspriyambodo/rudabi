...
<div class="card card-custom" data-card="true" id="kt_card_1">
    <div class="card-header">
        <div class="card-title">
            <a href="<?php echo base_url('Applications/Siwak/Wakaf/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $param[1]))); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
            ...
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody class="text-center">
                    ...
                    foreach ($a as $b) {
                        ...
                        ?>
                        <tr>
                            <td style="text-align:left !important;"><?php echo '<a href="' . base_url('Applications/Siwak/Wakaf/Kecamatan?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $param[1] . '&c=' . $param[2] . '&d=' . $param[3] . '&e=' . $b->lokasi_ID . '&f=' . $b->lokasi_nama))) . '" title="Detail Kecamatan ' . $b->lokasi_nama . '">' . $b->lokasi_nama . '</a>' ?></td>
