                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                if (!isset($b->province_title)) {
                                    ...
                                    echo '<a href="' . base_url('Applications/Binsyar/Ahli/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->tenaga_provinsi . '&b=' . $b->province_title))) . '" class="btn btn-icon btn-default btn-xs" title="Detail Provinsi ' . $b->province_title . '"><i class="fas fa-eye"></i></a>';
                                }
                                ?>
                            </td>
                        </tr>
