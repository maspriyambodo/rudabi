...
<div class="card card-custom" data-card="true" id="kt_card_1">
    <div class="card-header">
        <div class="card-title">
            <a href="<?php echo base_url('Binsyar/Mushalla/index/'); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            <td style="text-align:left !important;">
                                <?php echo '<a href="' . base_url('Binsyar/Mushalla/Detail?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $param[1] . '&c=' . $param[2] . '&d=' . $param[3] . '&e=' . $b->kecamatan_id . '&f=' . $b->kecamatan_name))) . '" title="Detail Kecamatan ' . $b->kecamatan_name . '">' . $b->kecamatan_name . '</a>' ?>
                            </td>
