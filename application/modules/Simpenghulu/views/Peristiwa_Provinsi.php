...
<div class="card card-custom" data-card="true" id="kt_card_1">
    <div class="card-header">
        <div class="card-title">
            <a href="<?php echo base_url('Simpenghulu/Peristiwa/index'); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <?php echo '<a href="' . base_url('Simpenghulu/Peristiwa/Detail?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->nikah_city_id . '&b=' . $b->city_title . '&c=' . $param[0] . '&d=' . $param[1]))) . '" title="Detail Peristiwa ' . $b->city_title . '">' . $b->city_title . '</a>'; ?>
                            </td>
