                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <?php echo '<a href="' . base_url('Simpenghulu/Peristiwa/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->city_province . '&b=' . $b->province_title))) . '" title="Detail Provinsi ' . $b->province_title . '">' . $b->province_title . '</a>'; ?>
                            </td>
