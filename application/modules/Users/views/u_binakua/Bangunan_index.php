                ...
                <tbody>
                    <?php foreach ($bangun as $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('Users/BKKS/Bangunan/Statusbangunan?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $value->stat . '&b=' . $value->kategori))); ?>" class="btn btn-icon btn-success btn-xs" title="Detail status bangunan KUA"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
