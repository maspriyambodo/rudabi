...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Catin Tahun <?php echo $param[0]; ?></h5>
        </div>
    </div>
</div>
<div class="card card-custom" data-card="true" id="kt_card_1">
    <div class="card-header">
        <div class="card-title">
            <a href="<?php echo base_url('Users/BKKS/Catin/index/'); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            <td style="text-align:left !important;">
                                <?php echo '<a href="' . base_url('Users/BKKS/Catin/Kabupaten?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $b->id_prop . '&c=' . $b->nama_lokasi))) . '" title="Detail Provinsi ' . $b->nama_lokasi . '">' . $b->nama_lokasi . '</a>'; ?>
                            </td>
                            <td><?php echo $b->target_wilayah; ?></td>
                            ...
                            <td><?php echo number_format($b->hadir_bimwin_suami); ?></td>
                            <td><?php echo number_format($b->hadir_bimwin_istri); ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
