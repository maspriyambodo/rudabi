                ...
                <tbody>
                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('Users/BKKS/KUA/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->kua_province_id . '&b=' . $b->province_title))); ?>" class="btn btn-icon btn-default btn-xs" title="Detail Provinsi <?php echo $b->province_title; ?>"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
