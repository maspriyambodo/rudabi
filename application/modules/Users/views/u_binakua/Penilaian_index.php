                ...
                <tbody class="text-center">
                    <?php foreach ($tahun as $dt_tahun) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('Users/BKKS/Penilaian/Tahun?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $dt_tahun->tahun))); ?>" class="btn btn-icon btn-success btn-xs" title="Detail Penilaian Tahun <?php echo $dt_tahun->tahun; ?>"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
