                ...
                <tbody>
                    <?php foreach ($reg as $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('Users/BKKS/Registrasi/Status?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $value->status . '&b=' . $value->kategori))); ?>" class="btn btn-icon btn-success btn-xs" title="Detail <?php echo $value->kategori ?>"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
