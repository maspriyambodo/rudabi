...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Rekap Penggunaan Simkah</h5>
        </div>
    </div>
</div>
                ...
                <tbody class="text-center">
                    <?php foreach ($simkah as $value) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('Users/BKKS/Simkah/Detail?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $value->simkah . '&b=' . $value->kategori))); ?>" class="btn btn-icon btn-success btn-xs" title="Detail Kategori <?php echo $value->kategori ?>"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
