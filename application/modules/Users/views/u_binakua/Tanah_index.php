...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Status Tanah KUA</h5>
        </div>
    </div>
</div>
                ...
                <tbody>
                    <?php foreach ($tanah as $dt_tanah) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('Users/BKKS/Tanah/Statustanah?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $dt_tanah->statustanah . '&b=' . $dt_tanah->keterangan))); ?>" class="btn btn-icon btn-success btn-xs" title="Detail status bangunan KUA"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
