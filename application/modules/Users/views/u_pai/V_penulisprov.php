...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5 text-uppercase">Data Penulis Provinsi <?php echo $param[1]; ?></h5>
        </div>
    </div>
</div>
<div class="card card-custom" data-card="true" id="kt_card_1">
    <div class="card-header">
        <div class="card-title">
            <a href="<?php echo base_url('Users/PAI/Penulis/index/'); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody class="text-center">
                    <?php
                    foreach ($a as $b) {
                        $c += $b->jumlah_penulis; // jumlah_penulis
                        ...
                        ?>
                        <tr>
                            <td style="text-align: left !important;"><?php echo '<a href="' . base_url('Users/PAI/Penulis/Kabupaten?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $param[1] . '&c=' . $b->city_id . '&d=' . $b->city_title))) . '" title="Detail Data ' . $b->city_title . '">' . $b->city_title . '</a>'; ?></td>
                            <td><?php echo number_format($b->jumlah_penulis); ?></td>
...
<input type="hidden" name="jumlah_penulis" readonly="" value="<?php echo $c; ?>"/>
...
<script>
    window.onload = function () {
        ...
        a = $('input[name="jumlah_penulis"]').val();
