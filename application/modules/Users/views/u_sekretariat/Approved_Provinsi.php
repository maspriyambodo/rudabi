...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <a href="<?php echo base_url('Users/Sekretariat/Approved/index?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun))); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody>
                    ...
                    foreach ($approved as $approved) {
                        ...
                        <tr>
                            <td>
                                <?php echo '<a href="' . base_url('Users/Sekretariat/Approved/Kabupaten?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $tahun . '&b=' . $id_provinsi . '&c=' . $approved->usul_kabupaten . '&d=' . $approved->kab_nama . ''))) . '">' . $approved->kab_nama . '</a>'; ?>
                            </td>
