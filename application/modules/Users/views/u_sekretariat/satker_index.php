            ...
            <table class="table table-bordered table-hover table-striped" style="width: 100%;">
                ...
                <tbody>
                    ...
                    foreach ($mpsdvm as $value) {
                        ...
                        <tr>
                            <td>
                                <a href="<?php echo base_url('Users/Sekretariat/Satker/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $value->kab_propinsi_id . '&b=' . $value->propinsi_nama)) . ''); ?>"><?php echo $value->propinsi_nama ?></a>
                            </td>
