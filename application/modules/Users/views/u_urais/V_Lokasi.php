...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Hisab Lokasi tahun <?php echo date('Y'); ?></h5>
        </div>
    </div>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (!isset($b->province_title)) {
                                    ...
                                    echo '<a href="' . base_url('Users/Binsyar/Lokasi/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->lokasi_provinsi . '&b=' . $b->province_title))) . '" title="" class="btn btn-icon btn-default btn-xs"><i class="fas fa-eye"></i></a>';
                                }
                                ?>
                            </td>
                        </tr>
