...
{
    $query = $this->db_database6->select("a.*")
                ->from("v_ambil_alat as a")
                ->get()->result();
    return $query;

    // $query = $this->db_database6->query("
    //     SELECT
...
function get_tenagaprovinsi($provinsi)
{
  $query = $this->db_database6->query("
    SELECT
    a.tenaga_kota,
...
function get_hisabprovinsi($provinsi)
{
  $query = $this->db_database6->query("
    SELECT
    b.city_title,
...
function get_hisablokasiprovinsi($provinsi)
{
  $query = $this->db_database6->query("
    SELECT
    a.lokasi_kota,
...
function get_hisablaporanprovinsi($provinsi)
{
  $query = $this->db_database6->query("
    SELECT
...
function get_lintangprovinsi($provinsi)
{
  $query = $this->db_database6->query("
    SELECT
