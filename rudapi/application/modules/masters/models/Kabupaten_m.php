...
class Kabupaten_m extends CI_Model {
	...
	var $table = 'view_kabupaten';
    var $column_search = ['provinsi','kabupaten','status'];
    var $order = array('id_kabupaten' => 'asc');
    ...
    {
        $query = $this->db->get_where('mst_kabupaten', array('id_kabupaten' => $id))->row();
        return $query;
    }

    public function perbaharuiData($id_k, $data)
    {
        $this->db->where("id_kabupaten", $id_k);
...
/* Location: ./application/modules/masters/models/Kabupaten_m.php */