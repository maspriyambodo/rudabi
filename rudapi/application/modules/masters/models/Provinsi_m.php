...
class Provinsi_m extends CI_Model {
	...
	var $table = 'mst_provinsi';
    var $column_search = ['nama'];
    var $order = array('id_provinsi' => 'asc');
    ...
    {
        $query = $this->db->get_where('mst_provinsi', array('id_provinsi' => $id))->row();
        return $query;
    }
...
/* Location: ./application/modules/masters/models/Provinsi_m.php */