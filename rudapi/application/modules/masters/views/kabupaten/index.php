  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Form Tambah Kabupaten</h4>
        ...
        <form>
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="id_kabupaten" autocomplete="off" placeholder="ID Kabupaten">
            </div>

            <div class="form-group">
              <label>Nama Kabupaten</label>
              <input type="text" class="form-control" name="nama" autocomplete="off" placeholder="Nama Kabupaten">
            </div>

            <div class="form-group">
              <label>Latitude</label>
              <input type="text" class="form-control" name="latitude" autocomplete="off" placeholder="Latitude Kabupaten">
            </div>

            <div class="form-group">
              <label>Longitude</label>
              <input type="text" class="form-control" name="longitude" autocomplete="off" placeholder="Longitude Kabupaten">
            </div>
          </div>
          <!-- /.card-body -->
        </form>
...
<script type="text/javascript">
    ...
    columns: [
        {
            ...
            o.value = ''
              +('<a class="text-dark" href="javascript:;" onclick="Page.Detail(\'' + o.value + '\')" data-toggle="tooltip" data-html="true" title="Lihat Kabupaten" style="margin-right:20px;"><i class="fa fa-eye"></i><a>')
            <?php if ($this->datainclude->_edited()) : ?>
              +('<a class="text-warning btn_edit" href="javascript:;" onclick="Page.Edited(\'' + o.value + '\')" data-toggle="tooltip" data-html="true" title="Edit Kabupaten" style="margin-right:20px;"><i class="fa fa-edit"></i><a>')
            <?php endif; ?>
            <?php if ($this->datainclude->_deleted()) : ?>
              +('<a class="text-danger btn_hapus" href="javascript:;" onclick="Page.Delete(\'' + o.value + '\')" data-toggle="tooltip" data-html="true" title="Hapus Kabupaten" style="margin-right:10px;"><i class="fa fa-minus-circle"></i><a>')
            <?php endif; ?>
    ...
    Page.Simpan = function(){
      ...
      if(id_provinsi == 'Pilih'){
        ...
        $.ajax({
          url: '<?php echo base_url();?>masters/kabupaten/tambah',
          type: 'POST',
          data: {id_provinsi:id_provinsi, id_kabupaten:id_kabupaten, nama:nama, latitude:latitude, longitude:longitude},
    ...
    // hapus data
    Page.Delete = function(id_kabupaten) {
      Swal.fire({
      ...
      {
        $.ajax({
          url: '<?php echo base_url(); ?>masters/kabupaten/hapus',
          type: 'POST',
    ...
    Page.Edited = function(id_kabupaten){
      // console.log(id_kabupaten);
      if(id_kabupaten != '') {
        window.location.href = '<?php echo base_url(); ?>masters/kabupaten/edited/' + id_kabupaten;
      }
    };

    // Inputan Tertentu
    $(function(){
      $("input[name='id_kabupaten']").on('input', function(e) {
