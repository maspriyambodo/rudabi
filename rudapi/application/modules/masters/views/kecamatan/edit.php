              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <select class="form-control" name="id_kabupaten">
                    ...
                    <option <?php if($tampil->id_kabupaten == $p->id_kabupaten){ echo 'selected'; }?> value="<?php echo $p->id_kabupaten;?>"><?php echo $p->nama;?></option>
                    <?php }?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="id_kecamatan" autocomplete="off" value="<?php echo $tampil->id_kecamatan;?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="is_actived">
                    <option>Pilih</option>
                    <option <?php if($tampil->is_actived == 1){ echo 'selected'; }?> value="1">Kecamatan Aktif</option>
                    <option <?php if($tampil->is_actived == 0){ echo 'selected'; }?> value="0">Kecamatan Nonaktif</option>
                  </select>
                </div>
              </div>
              <!-- /.card-body -->
...
<script type="text/javascript">
    ...
    Page.Simpan = function(){
      ...
      if(id_kabupaten == 'Pilih'){
        Swal.fire("Gagal!", "Kabupaten Tidak Boleh Kosong.", "error");
        ...
        Swal.fire("Gagal!", "Status Kecamatan Tidak Boleh Kosong.", "error");
      }else{
        $.ajax({
          url: '<?php echo base_url();?>masters/kecamatan/perbaharui',
          type: 'POST',
          data: {id_kabupaten:id_kabupaten, id_kecamatan:id_kecamatan, nama:nama, latitude:latitude, longitude:longitude, is_actived:is_actived},
