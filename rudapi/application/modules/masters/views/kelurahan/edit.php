              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <select class="form-control" name="id_kecamatan">
                    ...
                    <option <?php if($tampil->id_kecamatan == $p->id_kecamatan){ echo 'selected'; }?> value="<?php echo $p->id_kecamatan;?>"><?php echo $p->nama;?></option>
                    <?php }?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="id_kelurahan" autocomplete="off" value="<?php echo $tampil->id_kelurahan;?>">
                </div>
                ...
                <div class="form-group">
                  <label>Status Kelurahan</label>
                  <select class="form-control" name="is_actived">
                    <option>Pilih</option>
                    <option <?php if($tampil->is_actived == 1){ echo 'selected'; }?> value="1">Kelurahan Aktif</option>
                    <option <?php if($tampil->is_actived == 0){ echo 'selected'; }?> value="0">Kelurahan Nonaktif</option>
                  </select>
                </div>
              </div>
              <!-- /.card-body -->
...
<script type="text/javascript">
    ...
    Page.Simpan = function(){
      ...
      if(id_kecamatan == 'Pilih'){
        Swal.fire("Gagal!", "Kecamatan Tidak Boleh Kosong.", "error");
        ...
        Swal.fire("Gagal!", "Status Kelurahan Tidak Boleh Kosong.", "error");
      }else{
        $.ajax({
          url: '<?php echo base_url();?>masters/kelurahan/perbaharui',
          type: 'POST',
          data: {id_kecamatan:id_kecamatan, id_kelurahan:id_kelurahan, nama:nama, latitude:latitude, longitude:longitude, is_actived:is_actived},
