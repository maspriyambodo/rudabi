            ...
            <form>
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="id_provinsi" autocomplete="off" value="<?php echo $tampil->id_provinsi;?>">
                </div>
                ...
                <div class="form-group">
                  <label>Status Provinsi</label>
                  <select class="form-control" name="is_actived">
                    <option>Pilih</option>
                    <option <?php if($tampil->is_actived == 1){ echo 'selected'; }?> value="1">Provinsi Aktif</option>
                    <option <?php if($tampil->is_actived == 0){ echo 'selected'; }?> value="0">Provinsi Nonaktif</option>
                  </select>
                </div>
              </div>
              <!-- /.card-body -->
...
<script type="text/javascript">
    ...
    Page.Simpan = function(){
      ...
      if(id_provinsi == ''){
        ...
        $.ajax({
          url: '<?php echo base_url();?>masters/provinsi/perbaharui',
          type: 'POST',
          data: {id_provinsi:id_provinsi, nama:nama, latitude:latitude, longitude:longitude, is_actived:is_actived},
