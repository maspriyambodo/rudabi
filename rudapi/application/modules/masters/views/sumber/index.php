...
<script type="text/javascript">
    ...
    remoteSort: true,
    proxy: {
    url: '<?php echo base_url('master-sumber'); ?>'
    }},
    trackOver: true,
    selModel: {
    type: 'rows',
    ...
    Page.Simpan = function(){
      ...
      if(id_direktorat == 'Pilih'){
        ...
        $.ajax({
          url: '<?php echo base_url();?>masters/sumber/tambah',
          type: 'POST',
          data: {id_direktorat:id_direktorat, nama:nama, situs:situs, ip_lokal:ip_lokal, keterangan:keterangan},
    ...
    Page.Delete = function(id) {
      ...
      {
        $.ajax({
          url: '<?php echo base_url(); ?>masters/sumber/hapus',
          type: 'POST',
          data: {id:id},
          success: function(response){
    ...
    Page.Edited = function(id){
      console.log(id);
      if(id != '') {
        window.location.href = '<?php echo base_url(); ?>masters/sumber/edited/' + id;
      }
    };
